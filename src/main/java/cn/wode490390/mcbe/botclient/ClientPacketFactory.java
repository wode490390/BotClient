...
public class ClientPacketFactory {
    ...
    private static final Vector3f vector3f = vector3i.toFloat();
    ...
    private static Vector3i randomVector3i() {
        return new Vector3i(rand.nextInt(0xffffffff), rand.nextInt(255), rand.nextInt(0xffffffff));
    }
    ...
    public static LoginPacket randomLoginPacket() {
        String playerName = "wode" + Math.abs(rand.nextInt());
        ...
        skinDataJSON.put("ClientRandomId", Math.abs(rand.nextLong()));
    ...
    static {
        ...
        playerActionPacket7.setBlockPosition(vector3i);
    ...
    public static EntityEventPacket randomEntityEventPacket57() {
        entityEventPacket57.setData(Math.abs(rand.nextInt(0xffffffff))); //>0
    ...
    static {
        ...
        playerActionPacket1Or2.setBlockPosition(vector3i);
    ...
    public static PlayerActionPacket randomPlayerActionPacket1Or2() {
        playerActionPacket1Or2.setBlockPosition(randomVector3i());
    ...
    static {
        ...
        playerActionPacket14.setBlockPosition(vector3i);
    ...
    static {
        playerActionPacket.setBlockPosition(vector3i);
    ...
    static {
        ...
        movePlayerPacketR.setPosition(vector3f);
    }
